  ...
  return (
    <div className="w-full h-[80px] lg:h-[100px] px-4 lg:px-10 flex items-center justify-between">
      <div className="flex items-center gap-4 lg:gap-10">
        <img src={logo} alt="Techon" className="w-[50px] lg:w-[90px] h-auto object-contain" />
        <h1 className="hidden sm:block font-poppins font-bold text-[14px] lg:text-[24px] text-[#0a1445] leading-none">
          Dashboard
        </h1>
      </div>

      <div className="flex items-center gap-3 lg:gap-6">
        <img src={message} alt="Message" className="w-[19px] lg:w-[29px]" />
        <div className="h-[25px] lg:h-[30px] w-[1px] bg-gray-400/30 mx-1 lg:mx-2"></div>
        <div className="flex items-center gap-2 lg:gap-4">
          <img src={profile} className="w-[25px] lg:w-[45px] h-[35px] lg:h-[45px] rounded-full object-cover" alt="profile" />
